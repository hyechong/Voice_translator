...
selectedBtns.forEach((btn) => {
  btn.addEventListener('click', function () {
    ...
    const langFrom = this.getAttribute('id');
    toElmt.textContent = toLang;
    toElmt.setAttribute('value', langFrom);
    toTextArea.setAttribute('placeholder', `${toLang}로 번역됩니다.`);
  });
});
...
$(function () {
  ...
  $('.switch-btns').click(function () {
    ...
    toText.attr('placeholder', `${tempValue}로 번역됩니다.`);
  });
});
